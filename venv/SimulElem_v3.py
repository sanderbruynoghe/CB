...
class BatteryPack():
    ...
    def __init__(self, number_of_batt, usable_energy_one, min_energy_one, max_charge_bat, max_discharge_bat, init_soc_bat):
        self.b = number_of_batt
        self.max_soc = usable_energy_one * number_of_batt
        self.min_soc = min_energy_one * number_of_batt
        self.max_charge = max_charge_bat * number_of_batt #ASSUMED: linear in number of batteries
        self.max_discharge = max_discharge_bat * number_of_batt
        self.soc = init_soc_bat * number_of_batt
...
class FuelTankElectrolyzer():
    ...
    def __init__(self, max_soc, min_soc, fuel_cell_factor, electr_factor, max_charge_fte, max_discharge_fte, init_soc_fte):
        self.max_soc = max_soc
        self.min_soc = min_soc
        self.alpha = fuel_cell_factor
        self.beta = electr_factor
        self.max_charge = max_charge_fte
        self.max_discharge = max_discharge_fte
        self.soc = init_soc_fte
